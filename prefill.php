...
$fields = [
    ...
    'package_vendor' =>         ['Package vendor',        '<vendor> in https://github.com/adamibrahim/superauth',   '{author_github_username}'],
    'package_name' =>           ['Package name',          '<package> in https://github.com/adamibrahim/superauth',  ''],
    'package_description' =>    ['Package very short description',   'Laravel 5.5 Natively Email confirmation Package',                                     ''],

    'psr4_namespace' =>         ['PSR-4 namespace',       'usually, Adam\\Superauth',   '{package_vendor}\\{package_name}'],
];
